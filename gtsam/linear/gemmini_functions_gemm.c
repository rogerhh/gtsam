...
// #include <assert.h>
// 
// #define MATMUL_BLOCK_SIZE 4
// 
// void tiled_matmul_auto_cpu(
...
//   size_t stride_Ci = stride_C, stride_Cj = 1, stride_Di = stride_D, stride_Dj = 1;
// 
//   if(transpose_A) {
//     stride_Ai = 1;
//     stride_Ak = stride_A;
...
//       const elem_t* Bkj = Bj;
//       size_t k = 0;
//       size_t A_index[MATMUL_BLOCK_SIZE] = {0};
//       size_t B_index[MATMUL_BLOCK_SIZE] = {0};
//       for(int k = 0; k < MATMUL_BLOCK_SIZE; k++) {
// 	A_index[k] = k * stride_Ak;
// 	B_index[k] = k * stride_Bk;
//       }
// 
//       for(; k + MATMUL_BLOCK_SIZE < dim_K; k += MATMUL_BLOCK_SIZE) {
// 	// Hope this auto vectorizes
//         *Cij += A_scale_factor * B_scale_factor * Aik[A_index[0]] * Bkj[B_index[0]] + D_scale_factor * (*Dij);
//         *Cij += A_scale_factor * B_scale_factor * Aik[A_index[1]] * Bkj[B_index[1]] + D_scale_factor * (*Dij);
//         *Cij += A_scale_factor * B_scale_factor * Aik[A_index[2]] * Bkj[B_index[2]] + D_scale_factor * (*Dij);
//         *Cij += A_scale_factor * B_scale_factor * Aik[A_index[3]] * Bkj[B_index[3]] + D_scale_factor * (*Dij);
// 	Aik += stride_Ak * MATMUL_BLOCK_SIZE;
// 	Bkj += stride_Bk * MATMUL_BLOCK_SIZE;
//       }
//       for(; k < dim_K; k++) {
//         *Cij += A_scale_factor * (*Aik) * B_scale_factor * (*Bkj) + D_scale_factor * (*Dij);
//         Aik += stride_Ak;
//         Bkj += stride_Bk;
//       }
//       Bj += stride_Bj;
...
//   bool transpose_A, bool transpose_B) {
// 
//   tiled_matmul_auto_cpu(dim_I, dim_J, dim_K,
//                     A, B, C, C,
...
// 
//   tiled_matmul_auto_cpu(dim_I, 1, dim_K,
//                     A, x, z, y,
//                     stride_A, 1, 1, 1,
